...
summaries_byCounty_byMode = estimates |> 
  summarize(
    ...
    votes_total_22 = sum(votes_precTotal_22, na.rm = TRUE),
    ...
    demShare_lower = demVotes_lower / votes_total_22,
    demShare_estimate = demVotes_estimate / votes_total_22,
    demShare_upper = demVotes_upper / votes_total_22,
    repShare_lower = repVotes_lower / votes_total_22,
    repShare_estimate = repVotes_estimate / votes_total_22,
    repShare_upper = repVotes_upper / votes_total_22,
...
`r summaries$votes_total_22` votes are in, `r summaries$votes_total_22 / summaries$votes_total_20`% of the 2020 total

_Precincts reporting all modes_: `r prec_reported_all` out of `r prec_total` total precincts (`r 100*round(prec_reported_all / prec_total, 2)`%)

_Precincts reporting Election Day_: `r prec_reported_eday` out of `r prec_total` total precincts (`r 100*round(prec_reported_eday / prec_total, 2)`%)

## Estimated Vote Share (Dem vs. Rep)

_Swing_: `r 100*(summaries$demShare_estimate - summaries$repShare_estimate)`% with uncertainty bounds [`r 100*(summaries$demShare_lower - summaries$repShare_lower)`% -- `r 100*(summaries$demShare_upper - summaries$repShare_upper)`%]

_Swing vs 2020_: `r 100*(summaries$swing_estimate)`% with uncertainty bounds [`r 100*(summaries$swing_lower)`% -- `r 100*(summaries$swing_upper)`%]

_Democrat_: `r summaries$demVotes_estimate` with uncertainty bounds [`r summaries$demVotes_lower` -- `r summaries$demVotes_upper`]

_Republican_: `r summaries$repVotes_estimate` with uncertainty bounds [`r summaries$repVotes_lower` -- `r summaries$repVotes_upper`]
