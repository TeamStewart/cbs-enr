...
tar_read(model_MI_Eaton) |> list2env(envir = .GlobalEnv) |> invisible()
...
tar_read(plot_voteShare_MI_Eaton)
...
tar_read(plot_margin2020_MI_Eaton)
...
tar_read(plot_votesEDay_MI_Eaton)
...
tar_read(plot_votesAll_MI_Eaton)
...
tar_read(tbl_countyMode_MI_Eaton)
