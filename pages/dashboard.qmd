...
# setup blank files if needed
create_0file(glue("{PATH_DROPBOX}/{ELECTION_FOLDER}/NY/numbers/prec_reported"))
create_0file(glue("{PATH_DROPBOX}/{ELECTION_FOLDER}/NY/numbers/prec_reported_eday"))
create_0file(glue("{PATH_DROPBOX}/{ELECTION_FOLDER}/VA/numbers/prec_reported"))
create_0file(glue("{PATH_DROPBOX}/{ELECTION_FOLDER}/VA/numbers/prec_reported_eday"))
