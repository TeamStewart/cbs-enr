...
Last updated: `r lubridate::ymd_hms(targets::tar_read(time_NC_ALL_primary))`

```{r}

targets::tar_read(tbl_all_NC_ALL_primary)
...
img_files <- list.files(path = "model_summaries", pattern = "NC.*?jpeg", full.names = TRUE)
