...
data_hod_base = merge_data(
  ...
  mutate(
    ######
    # !!! ADDS FAKE DATA FOR TESTING !!!
    ######
    turnout = votes_precFinal_24 * rnorm(n(), 0.7, 0.05) + rnorm(n(), 15, 50),
    votes_statehouse_25 = case_when(
      party == "dem" ~ votes_potus_24_dem * rnorm(n(), 0.7, 0.05) + rnorm(n(), 10, 50),
      party == "rep" ~ votes_potus_24_rep * rnorm(n(), 0.7, 0.05) + rnorm(n(), 10, 50),
      .default = abs(rnorm(n(), 10, 20))
    )
    ######
  )
